...
<ol reversed style="line-height: 1.5; text-align: justify;">
    <li style="margin-bottom: 20px; line-height: 1.5;">
        <div><em>Unifying deterministic and stochastic thermodynamic speed limits on observables</em></div>
        <div><strong>Swetamber Das</strong> and Jason R. Green</div>
        <div>
    ...
    <li style="margin-bottom: 20px; line-height: 1.5;">
        ...
        <div>Mohamed Sahbani, <strong>Swetamber Das</strong>, and Jason R. Green</div>
        <div>
            <a href="" target="_blank" class="publication-link">
            </a>
        </div>
...
<ol reversed style="line-height: 1.5; text-align: justify;">
    ...
    <li style="margin-bottom: 20px; line-height: 1.5;">
    <div><em>Force Geometry and Irreversibility in Nonequilibrium Dynamics</em></div>
